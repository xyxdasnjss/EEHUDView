...
* 以下のクラスメソッドを呼ぶ事でHUD(progressタイプ)を表示する事ができます。
@+ (void)progressWithMessage:showStyle:hideStyle:progressViewStyle:progress:@
...
*_EEHUDResultViewStyleClock_*
!https://lh5.googleusercontent.com/-pEnuvZie0DI/T-RY9Zh7IxI/AAAAAAAAAPw/xdG7SYt76WU/s800/029_clock.png!||


h3. progressViewStyle (progressタイプの表示アイコン)

|*_EEHUDProgressViewStyleBar_*
!https://lh4.googleusercontent.com/-sLOxaXcxq6A/T-HI2Le-U3I/AAAAAAAAAPc/vheYOPW_LF8/s800/-001_progressBar.png!|
||
